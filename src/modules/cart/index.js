  ...
  return (
    ...
    <div class="flex shadow-md my-10">
      <div class="w-3/4 bg-white px-10 py-10">
        ...
        {cart?.map(item => {
          ...
          <div class="flex w-2/5"> 
            ...
            <div class="flex flex-col justify-between ml-4 flex-grow">
              ...
              <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={()=> handleRem(item?.id)}>Remove</a>
            </div>
          </div>
          <div class="flex justify-center w-1/5">
            <svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512" onClick={()=> handleDec(item?.id)}><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
            </svg>

            <input class="mx-2 border text-center w-8" type="text" value={item?.quantity} />

            <svg class="fill-current text-gray-600 w-3" viewBox="0 0 448 512" onClick={()=> handleInc(item?.id)}>
        ...
        <Link to={"/"} href="#" class="flex font-semibold text-indigo-600 text-sm mt-10">
